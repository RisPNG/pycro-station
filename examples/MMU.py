    ...
    def process_files(self):
        ...
        try:
            ...
            for master_path in self.full_master_file_path:
                ...
                self.third_frame_textbox_1.insert("end", f"Saved new file at {master_path}_UPDATED.xlsx\n\n")
                self.third_frame_textbox_1.see("end")
            ...
            new_wb.save(f"{work_path}/New_PO_List.xlsx")
            self.third_frame_textbox_1.insert("end", f"Saved new PO list file at {work_path}/New_PO_List.xlsx\n\n")
            self.third_frame_textbox_1.see("end")
            ...
            self.third_frame_textbox_1.see("end")
            self.third_frame_textbox_1.configure(state="disabled")

            # Switch to Reports frame after processing
            self.second_frame_textbox_1.configure(state="disabled")
            self.frame_2_button.configure(image=self.reports_done, text="Reports (Done)")
            self.home_button.configure(fg_color="transparent")
            ...
            self.second_frame_textbox_1.configure(state="disabled")
            self.frame_2_button.configure(image=self.reports_error, text="Reports (Error)")

            # Switch to Logs frame after error
            self.home_button.configure(fg_color="transparent")
            self.frame_2_button.configure(fg_color="transparent")
            self.frame_3_button.configure(fg_color=("gray75", "gray25"))
            self.home_frame.grid_forget()
